...
error rate (WER)---a paired bootstrap over 10{,}000 resamples of the 62 held-out
sentences confirms significance at $p<10^{-4}$ with large effect sizes
(Cohen's $d_z>1.5$)---while the Mamba-3 hybrid used 27.4\% fewer parameters
than the Conformer. We report all headline comparisons with bootstrap
...
Sentence-mean metrics with bootstrap 95\% CIs appear in
Table~\ref{tab:phase2stats} and Fig.~\ref{fig:phase2metrics}; the paired
bootstrap on the difference (Table~\ref{tab:bootstrap},
Fig.~\ref{fig:bootstrapdelta}) shows both Mamba--Conformer gaps are
significant at $p<10^{-4}$ with large effect sizes. Note the
corpus-level WER (92.0\%) and sentence-mean WER (89.0\%) for the Conformer
differ by construction (Section~\ref{sec:metrics}); both are reported to
keep the accounting honest.

\begin{table}[htbp]
\centering
\caption{Study 3 --- sentence-mean metrics with bootstrap 95\% CIs
(10{,}000 resamples over 62 sentences).}
\label{tab:phase2stats}
\begin{tabular}{llrrr}
\toprule
Model & Metric & Mean $\pm$ SD & Bootstrap 95\% CI \\
\midrule
\multirow{4}{*}{Conformer}
 & WER & $0.890 \pm 0.091$ & [0.867, 0.913] \\
 & CER & $0.686 \pm 0.144$ & [0.651, 0.721] \\
 & CTC CER & $0.476 \pm 0.086$ & [0.454, 0.497] \\
 & SemER & $0.098 \pm 0.011$ & [0.095, 0.101] \\
\midrule
\multirow{4}{*}{BiMamba-2 + gated MLP}
 & WER & $0.723 \pm 0.121$ & [0.692, 0.754] \\
 & CER & $0.575 \pm 0.166$ & [0.534, 0.615] \\
 & CTC CER & $0.459 \pm 0.082$ & [0.439, 0.479] \\
 & SemER & $0.091 \pm 0.009$ & [0.089, 0.094] \\
\midrule
\multirow{4}{*}{Mamba-3 stabilised hybrid}
 & WER & $0.722 \pm 0.099$ & [0.697, 0.746] \\
 & CER & $0.602 \pm 0.140$ & [0.567, 0.636] \\
 & CTC CER & $0.498 \pm 0.074$ & [0.480, 0.516] \\
 & SemER & $0.096 \pm 0.011$ & [0.093, 0.099] \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Paired bootstrap on metric differences vs.\ the Conformer baseline
(sentence-mean metrics; $\Delta$ = reduction; all $p<10^{-4}$).}
\label{tab:bootstrap}
\begin{tabular}{llrrrr}
\toprule
Comparison & Metric & $\Delta$ & 95\% CI & Cohen's $d_z$ & Cliff's $\delta$ \\
\midrule
Conf.\ vs.\ BiMamba-2+MLP & WER & 16.7\% & [14.8, 18.6] & 2.171 & 0.717 \\
Conf.\ vs.\ BiMamba-2+MLP & CER & 11.1\% & [9.4, 12.9] & 1.541 & 0.399 \\
Conf.\ vs.\ Mamba-3 hybrid & WER & 16.9\% & [15.0, 18.6] & 2.337 & 0.771 \\
Conf.\ vs.\ Mamba-3 hybrid & CER & 8.4\% & [7.3, 9.5] & 1.866 & 0.335 \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Paired bootstrap on the Conformer--Mamba differences; all CIs lie
far from zero.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{distribution_wer_cer_violin.png}
...
large, statistically significant effect sizes}.
